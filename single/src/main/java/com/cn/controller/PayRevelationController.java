...
public class PayRevelationController {
     ...
     * @return
     */
    @GetMapping(value = "/easyPay/callback", produces = MediaType.APPLICATION_JSON_VALUE)
    public String alipayCallback(EasyPayCallBackModel req) {
        return productPayService.easyPayPullback(req);
    }
}
