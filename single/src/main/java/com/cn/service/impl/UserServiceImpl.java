...
public class UserServiceImpl implements UserService {
    ...
    public UserInfoVo getCurrentUserInfo() {
        ...
        final boolean isMember = true && expirationTime != null && !expirationTime.isBefore(currentTime);



        return new UserInfoVo()
                .setUserId(currentUserInfo.getUserID())
                .setAccountBalance(currentUserInfo.getAccountBlance())
                ...
                .setPhoneNumber(currentUserInfo.getPhoneNumber())
    ...
    public void updateUserInfo(final UpdateUserInfoDto dto) {
        ...
        tsUserMapper.updateById(
                new TsUser().setUserId(dto.getUserId())
                        ...
                        .setAccountBalance(dto.getAccountBalance())
        );
                ...
                StpUtil.getSessionByLoginId(dto.getUserId())
                        .set(UserCacheConstant.USER_INFO_DATA,
                                currentUserInfo.setType(dto.getType())
                                        .setNickName(dto.getNickName())
                                        .setExpirationTime(dto.getExpirationTime())
                                        .setAccountBlance(dto.getAccountBalance())
                                        .setPhoneNumber(dto.getPhoneNumber())
                        );
            }
        }
    ...
    public IPage<UserPageVo> getUserPage(final int pageNum, final String prompt) {
        ...
        return tsUserMapper.selectPage(new Page<>(pageNum, 15), new QueryWrapper<TsUser>()
                ...
                .orderByDesc(TsUser::getCreatedTime)
                .select(TsUser::getUserId,
                        TsUser::getType,
                        TsUser::getNickName,
                        TsUser::getEmail,
                        TsUser::getExpirationTime,
                        TsUser::getCreatedTime,
                        TsUser::getUpdateTime,
            ...
            return new UserPageVo()
                    ...
                    .setAccountBalance(t.getAccountBalance())
    ...
    @Override
    public TsUser getUserById(long userID) {
        return tsUserMapper.selectById(userID);
    }
