...
import BalanceRecodsView from "@/views/setting/view/BalanceRecodsView.vue";
import UserGptView from "@/views/setting/view/UserGptView.vue";
import HelpView from "@/views/setting/view/HelpView.vue";
...
const routes = [
    ...
    {
        path: '/setting/balanceRecords',
        name: 'setting-balanceRecords',
        component: BalanceRecodsView,
        meta: {title: 'SETTING-BALANCERECORDS', keepAlive: false}
    },
    {
        path: '/setting/userGpt',
        name: 'setting-userGpt',
        component: UserGptView,
        meta: {title: 'SETTING-UserGpt', keepAlive: false}
    },
    {
        path: '/setting/Help',
        name: 'setting-help',
        component: HelpView,
        meta: {title: 'SETTING-HELP', keepAlive: false}
    },
]
...
router.beforeEach(async (to) => {
    let {title} = to.meta
    // TODO 设置浏览器Title
    document.title = (title ? title : '') + '- YS GPT'
})
