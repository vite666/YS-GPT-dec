...
import PasswordLoginComponent from "@/components/auth/components/PasswordLoginComponent.vue";
import PhoneNumberRegisterComponent from "@/components/auth/components/PhoneNumberRegisterComponent.vue";
...
<!--        </div>-->
        ...
        <div v-if="isStatus===1">
          <password-login-component @change-status-event="onChangeStatus" @on-close="onClose"/>
        </div>
        <div v-if="isStatus===2">
          <phone-number-register-component @change-status-event="onChangeStatus" @on-close="onClose"/>
        </div>
...
<!--               alt="">-->
          <span @click="onChangeStatus(2)" v-show="isStatus===1" style="cursor:pointer">
            注册/忘记密码
          </span>
          <span @click="onChangeStatus(1)" v-show="isStatus===2" style="cursor:pointer">
            登录
          </span>
