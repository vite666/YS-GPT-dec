...
import {computed, defineEmits, defineExpose, defineProps, onMounted, ref, nextTick} from "vue";
        ...
        <div :class="item.id===chatCache.currentId?'row-active':'row-default'"
          ...
          <div class="row-input">
            <div class="row-input-title">
              ...
              <el-input ref="inputRef" v-model="item.title"  @blur.stop="editTopicTitle(item.title,item.id)" v-else />
            </div>
