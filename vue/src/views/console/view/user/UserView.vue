...
const openUpdateDialog = (data) => {
  ...
  form.value.accountBalance = data.accountBalance
  ...
  <div class="container">
    <div class="body">
      ...
      >
        ...
        <el-table-column prop="phoneNumber" label="手机号" width="200px"/>
...
<!--          </template>-->
<!--        </el-table-column>-->
        <el-table-column prop="accountBalance" label="额度" width="200px"/>
...
<!--        </div>-->
      ...
      <el-form-item label="用户额度">
        <el-input placeholder="请设置用户额度" v-model="form.accountBalance" class="el-width"/>
      </el-form-item>
      <div class="prompt">
        设置用户的额度
      </div>
        <el-form-item label="用户手机号">
          <el-input placeholder="请设置用户手机号" v-model="form.phoneNumber" class="el-width"/>
        </el-form-item>
        <div class="prompt">
          设置用户手机号
        </div>
