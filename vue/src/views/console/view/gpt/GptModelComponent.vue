...
const openUpdateDialog = (data) => {
  ...
  form.value.promptPrice = data.promptPrice
  form.value.completionPrice = data.completionPrice
  ...
  <div class="container">
    <div class="body">
      ...
      >
        ...
        <el-table-column prop="content" label="模型说明" width="200px"/>
  ...
  >
    <div class="el-dialog-box">
      ...
      <el-form :inline="true" label-width="220px" label-position="left" class="el-form">
        ...
        <div class="prompt">
          top_p应该设置在<span>0.5到0.95之间</span>，这样可以保证生成的内容既有一定的多样性，又不会太过随机或错误。如果top_p太高，比如接近1，那么模型可能会生成一些不合逻辑或不相关的内容。如果top_p太低，比如接近0，那么模型可能会生成一些重复或无聊的内容。你可以根据你的任务和数据来调整top_p的值
        </div>
        ...
        <el-form-item label="提示信息价格元（每一百万）">
          <el-input placeholder="请设置提示词价格"
                    type="number"
                    v-model="form.promptPrice"
                    class="el-width"/>
        </el-form-item>

        <el-form-item label="补全信息价格元（每一百万）">
          <el-input placeholder="请设置补全信息价格"
                    type="number"
