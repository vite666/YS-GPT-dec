...
<!--      <div>-->
<!--        &lt;!&ndash;                <div class="img-round">&ndash;&gt;-->
<!--        &lt;!&ndash;                  <el-icon size="15px">&ndash;&gt;-->
<!--        &lt;!&ndash;                    <ZoomIn/>&ndash;&gt;-->
<!--        &lt;!&ndash;                  </el-icon>&ndash;&gt;-->
<!--        &lt;!&ndash;                </div>&ndash;&gt;-->
<!--        <div class="img-round" @click="emits('partial-repaint',props.type, props.image)" v-if="props.type ==='SD'">-->
<!--          <el-icon size="15px">-->
<!--            <EditPen/>-->
<!--          </el-icon>-->
<!--        </div>-->
